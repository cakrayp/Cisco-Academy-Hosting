...
(MButton = function(xml,divId){
	...
	$(xml).children().each(function(index, element) {	
		...
		if(xElement)
		{
			...
			{
			button = getCJSElement("IMAGE_BUTTON",{x:obj.buttonX,y:obj.buttonY,div:slideDivId,id:slideCnt,callback:th.clickHandler,compId:obj.compId,imgSel:obj.imgSel,imgOver:obj.imgOver});
			}
			else
			{
...
(VideoComp = function (obj) {
	...
	videoFrame.style.cssText = "top:0px;left:0px;visibility:hidden;border:0;-webkit-backface-visibility: hidden !important;"
