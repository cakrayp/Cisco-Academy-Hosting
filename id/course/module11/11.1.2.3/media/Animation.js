...
(lib.ID_txt11 = function() {
	...
	// ID_txt11
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt11",width:"200",expand:"up+down",align:"left"});
...
(lib.ID_txt10 = function() {
	...
	// ID_txt10
	this.text_1 = new DOMObject({type:"TEXT",compId:"ID_txt10",width:"200",expand:"up+down",align:"left"});
...
(lib.ID_txt09 = function() {
	...
	// ID_txt09
	this.text_2 = new DOMObject({type:"TEXT",compId:"ID_txt09",width:"70",expand:"left+right",align:"center"});
...
(lib.ID_txt07 = function() {
	...
	// ID_txt07
	this.text_4 = new DOMObject({type:"TEXT",compId:"ID_txt07",width:"200",expand:"up+down",align:"center"});
...
(lib.table2 = function() {
	...
	this.text_5.setTransform(348,67);
...
(lib.commonlazymc = function() {
	...
	this.instance_7.setTransform(420,225.2,1,1,0,0,0,29.3,8.5);

	// ID_txt10
	this.instance_8 = new lib.ID_txt10();
	this.instance_8.setTransform(420,81.2,1,1,0,0,0,29.3,8.5);

	// ID_txt09
	this.instance_9 = new lib.ID_txt09();
	this.instance_9.setTransform(370,151.7,1,1,0,0,0,40.5,8.5);

	// ID_txt08
	this.instance_10 = new lib.ID_txt08();
	this.instance_10.setTransform(356.5,48,1,1,0,0,0,101.5,8.5);

	// ID_txt07
	this.instance_11 = new lib.ID_txt07();
	this.instance_11.setTransform(88.9,48,1,1,0,0,0,80,8.5);
