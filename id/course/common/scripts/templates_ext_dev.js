...
(AnimationControl = function(obj){
	...
	{		 
		...
		cont.onMouseOver=function(ev)
		{
			...
			ev.target.tool.visible =ev.target.over.visible = true;
			ev.target.normal.visible = false;			
			ev.target.tool.y=ev.target.normal.y-35
			ev.target.tool.x=xpos						
			update = true;
		}
	...
	{	
		...
		var toolTip
		var	xpos=-5
		toolTip=new DOMObject({type:"TEXT",text:getMediaText("play"),class:"animTooltip",expand:"up",align:"center",width:"30"});				
		play_cont=createButton(imgs["play"],imgs["play_over"],playClickHandler,toolTip,xpos);			
		play_cont.name="play";
		play_cont.y=contyPos
		
		xpos=-10
		toolTip=new DOMObject({type:"TEXT",text:getMediaText("pause"),class:"animTooltip",expand:"up",align:"center",width:"30"});
		paus_cont=createButton(imgs["pause"],imgs["pause_over"],playClickHandler,toolTip,xpos);		
		...
		xpos=-10
		toolTip=new DOMObject({type:"TEXT",text:getMediaText("start"),class:"animTooltip",expand:"up",align:"center",width:"30"});
		buttonCont=createButton(imgs["start"],imgs["start_over"],playClickHandler,toolTip,xpos);				
		...
		xpos=-10
		toolTip=new DOMObject({type:"TEXT",text:getMediaText("rewind"),class:"animTooltip",expand:"up",align:"center",width:"40"});
		buttonCont=createButton(imgs["rewind"],imgs["rewind_over"],playClickHandler,toolTip,xpos);				
		...
		xpos=-30
		toolTip=new DOMObject({type:"TEXT",text:getMediaText("fforward"),class:"animTooltip",expand:"up",align:"center",width:"70"});
		buttonCont=createButton(imgs["forward"],imgs["forward_over"],playClickHandler,toolTip,xpos);			
		...
		xpos=-10
		toolTip=new DOMObject({type:"TEXT",text:getMediaText("end"),class:"animTooltip",expand:"up",align:"center",width:"30"});	
		buttonCont=createButton(imgs["end"],imgs["end_over"],playClickHandler,toolTip,xpos);			
		buttonCont.name="end"
		buttonCont.x = prevX + 33;
		prevX = buttonCont.x;
		buttonCont.y=contyPos;
...
(SyntaxComp = function (o) {
	...
	t.cd = function()
	{
		...
		$("#"+o.compId).append('<div  style="font-family:Courier New; line-height:12px; padding:3px 0px;"><span id='+o.compId+'_syn_'+cC+' class="promptText">'+promptText+'</span><span contenteditable="true" spellcheck="false"  id='+o.compId+'_prompt_'+cC+' class="cmd_box_'+cC+'"  style="font-family:Courier New; font-size:'+o.size+'px; height:13px !important; vertical-align: top; outline:none; display:inline; padding-right:25px;"></span></div>');
		...
		$(".cmd_box_"+cC).keypress(function(e){
		 //alert(this);
	...
	t.cl = function()
	{
		...
		$(".cmd_box_"+cC).css('padding-right', '25px');
	}
...
(DropContainer = function(compObj){
	...
	bg.graphics.beginLinearGradientFill(["#f4f3f4","#ffffff"], [0, 1], 0,0,0,compObj.height).beginLinearGradientStroke(["#747273","#d1cfd0"], [0, 1], 0, 0, 0, compObj.height).setStrokeStyle(2).drawRoundRect(0,0,compObj.width,compObj.height,5);
...
(DnDInstructionComp = function (obj) {
	...
	self.loadPopup = function()
	{
		...
		var dom = new createjs.DOMElement(popDiv);
...
function AnimationControlComp(_id)
{	
	 this.id = _id;
	...
	temp+='<div class="pause" title=""><img src="../../../common/images/animation-controller/pause.png" width="33" height="27" alt="Pause" id="pauseBtn"/></div>';

	temp+='<div class="resbut" title=""><img src="../../../common/images/animation-controller/play.png" width="33" height="27" alt="Play" id="restartBtn"/></div>';
	temp+='<div class="start" title=""><img src="../../../common/images/animation-controller/start.png" width="27" height="27" alt="First" id="firstBtn" /></div>';
	temp+='<div class="rewind" title=""><img src="../../../common/images/animation-controller/rewind.png" width="27" height="27" alt="Revind" id="rewindBtn" /></div>';
	temp+='<div class="forward" title=""><img src="../../../common/images/animation-controller/forward.png" width="27" height="27" id="forwardBtn" alt="Forward" /></div>';
	temp+='<div class="end" title=""><img src="../../../common/images/animation-controller/end.png" width="27" height="27" alt="End" id="endBtn" /></div>';
	temp+='<div id="slider">';
	temp+='</div>'; 
	...
	(function() {
		if(id != undefined){ 
			id=id-1;
			animeArray[id].animFunction(); 
		}else 
			animeArray[0].animFunction(); 
			 
			//tl.call(initAnimFunction);
			tl.pause();		
	})();
	...
	function mouseOverEventHandler(_this,e,value){ 
		...
		$('.strpopup').css({top: e.pageY -20, left: e.pageX+20}); 
		$(".strpopup").show(); 
	}
	...
	startBtn.mouseover(function(e){	 
		mouseOverEventHandler(this,e,'Play');
	...
	mouseOverEventHandler(this,e,'Pause');
	...
	mouseOverEventHandler(this,e,'Forward');	
	...
	mouseOverEventHandler(this,e,'Rewind');
	...
	firstBtn.mouseover(function(e){	 
		mouseOverEventHandler(this,e,'First');
	...
	endBtn.mouseover(function(e){	 	
		mouseOverEventHandler(this,e,'End');	
...
/*	$("a.ui-state-default, .ui-widget-content .ui-state-default, .ui-widget-header .ui-state-default").mousedown(function()
	{	
	$("a.ui-state-default, .ui-widget-content .ui-state-default, .ui-widget-header .ui-state-default>img").css(	
	{"background-image": "url(../../../common/images/animation-controller/play_ball_glow.png)"})	
	})	*/
