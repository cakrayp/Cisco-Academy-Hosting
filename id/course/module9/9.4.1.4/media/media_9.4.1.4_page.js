...
(slideViewDidLoad = function(){	
	...
	function initSlide()
	{
		var textArray = [{compId:"ID_txt01", x:"55", y:"146", width:"90", expand:"up+down", align:"center", size:"10" },
						...
						{compId:"ID_txt05", x:"235", y:"146", width:"90", expand:"up+down", align:"center", size:"10" },
						{compId:"ID_txt07", x:"344", y:"129", width:"34.2", expand:"right", align:"left", size:"10" },
						{compId:"ID_txt08", x:"282", y:"197", width:"34.2", expand:"right", align:"left", size:"10" },
						{compId:"ID_txt09", x:"211", y:"272", width:"134.6", expand:"up+down", align:"center", size:"10" },
						{compId:"ID_txt10", x:"414", y:"146", width:"90", expand:"up+down", align:"center", size:"10" },
						...
						{compId:"ID_txt13", x:"597", y:"148", width:"90", expand:"up+down", align:"center", size:"10" },
						{compId:"ID_txt14", x:"506", y:"274", width:"90", expand:"up+down", align:"center", size:"10" },
						{compId:"ID_txt17", x:"449", y:"260", width:"34.2", expand:"right", align:"right", size:"10" },
						{compId:"ID_txt18", x:"615", y:"260", width:"34.2", expand:"right", align:"left", size:"10" },
						{compId:"ID_txt19", x:"789", y:"146", width:"76.4", expand:"up+down", align:"center", size:"10" },
						{compId:"ID_txt20", x:"895", y:"130", width:"34.2", expand:"right", align:"left", size:"10" },
						{compId:"ID_txt21", x:"793", y:"196", width:"34.2", expand:"right", align:"right", size:"10" },
						{compId:"ID_txt22", x:"968", y:"146", width:"83.4", expand:"up+down", align:"center", size:"10" },
						...
						{compId:"ID_txt25", x:"1154", y:"138", width:"70.3", expand:"up+down", align:"center", size:"10" },
						...
						{compId:"ID_txt28", x:"944", y:"345", width:"128.6", expand:"up+down", align:"center", size:"10" },
						{compId:"ID_txt29", x:"1311", y:"143", width:"120.6", expand:"up+down", align:"center", size:"10" },
						 ];						
