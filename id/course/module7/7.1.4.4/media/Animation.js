...
(lib.ID_txt07 = function() {
	...
	// txt
	this.text = new DOMObject({type:"TEXT",compId:"ID_txt07",width:"460.05",expand:"down",align:"center"});	
...
(lib.EnvelopeStatic3 = function() {
	...
	this.instance.setTransform(32.9,22.1,0.8,0.8,0,0,0,1.4,0.1);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_4.setTransform(353.5,312,1,1,0,0,0,57.5,10);
	...
	this.instance_6.setTransform(77.5,312,1,1,0,0,0,57.5,10);
