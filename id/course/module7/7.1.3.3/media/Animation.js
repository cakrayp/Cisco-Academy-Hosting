...
(lib.EnvelopeStatic6 = function() {
	...
	// label
	this.text_26 = new DOMObject({type:"TEXT",compId:"ID_txt15",width:"50",expand:"down",align:"centre",size:"10"});
	this.text_26.setTransform(-18,-8.4);

	// Layer 1
	this.instance_15 = new lib.envelopeclosedstatic();
	this.instance_15.setTransform(0,0.1,0.506,0.506,0,0,0,1.3,0.2);
...
(lib.EnvelopeStatic4copy = function() {
	...
	// label
	this.text_27  = new DOMObject({type:"TEXT",compId:"ID_txt14",width:"100",expand:"down",align:"centre",size:"10"});
	
	this.text_27.setTransform(-18,-8.4);

	// Layer 1
	this.instance_16 = new lib.envelopeclosedstatic();
	this.instance_16.setTransform(0,0.1,0.506,0.506,0,0,0,1.3,0.2);
...
(lib.EnvelopeStatic4 = function() {
	...
	// label
		this.text_28 = new DOMObject({type:"TEXT",compId:"ID_txt13",width:"50",expand:"down",align:"centre",size:"10"});

		this.text_28.setTransform(-18,-8.4);

	// Layer 1
	this.instance_17 = new lib.envelopeclosedstatic();
	this.instance_17.setTransform(0,0.1,0.506,0.506,0,0,0,1.3,0.2);
...
(lib.EnvelopeStatic3 = function() {
	...
	// label
	this.text_29 = new DOMObject({type:"TEXT",compId:"ID_txt12",width:"100",expand:"down",align:"centre",size:"10"});
	this.text_29.setTransform(-18,-8.4);

	// Layer 1
	this.instance_18 = new lib.envelopeclosedstatic();
	this.instance_18.setTransform(0,0.1,0.506,0.506,0,0,0,1.3,0.2);
...
(lib.EnvelopeStatic2 = function() {
	...
	// label
	this.text_30 = new DOMObject({type:"TEXT",compId:"ID_txt11",width:"100",expand:"down",align:"centre",size:"10"});
	this.text_30.setTransform(-18,-8.4);

	// Layer 1
	this.instance_19 = new lib.envelopeclosedstatic();
	this.instance_19.setTransform(0,0.1,0.506,0.506,0,0,0,1.3,0.1);
...
(lib.EnvelopeStatic = function() {
	...
	// label
	this.text_31 = new DOMObject({type:"TEXT",compId:"ID_txt10",width:"100",expand:"down",align:"centre",size:"10"});

	this.text_31.setTransform(-18,-8.4);

	// Layer 1
	this.instance_20 = new lib.envelopeclosedstatic();
	this.instance_20.setTransform(0,0.1,0.506,0.506,0,0,0,1.3,0.2);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{},true);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(38).to({alpha:1},0).to({x:123.5,y:141.8},15).wait(21).to({startPosition:0},0).to({regX:17.1,regY:13.7,scaleX:0.43,scaleY:0.43,x:134.2,y:90.9},16).wait(9).to({startPosition:0},0).to({regX:17,scaleX:0.38,scaleY:0.38,x:132.2,y:91.8,alpha:0},10).wait(1).to({startPosition:0},0).wait(1200));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(38).to({alpha:1},0).to({x:76,y:141.8},15).wait(21).to({startPosition:0},0).to({regX:30.4,regY:13.7,scaleX:0.43,scaleY:0.43,x:113.7,y:90.9},16).wait(9).to({startPosition:0},0).to({regX:30.5,scaleX:0.38,scaleY:0.38,x:114.2,y:91.8,alpha:0},10).wait(1).to({startPosition:0},0).wait(1200));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(137).to({alpha:1},0).to({x:122,y:141.8},15).wait(21).to({startPosition:0},0).to({scaleX:0.43,scaleY:0.43,x:65.9,y:90.9},16).wait(9).to({startPosition:0},0).to({alpha:0},9).wait(1).to({startPosition:0},0).wait(1102));

	// t1_10.2.0.0
	this.instance_24 = new lib._10200_lt_bg("synched",0);
	this.instance_24.setTransform(44,252,1,1,0,0,0,30.5,13.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(137).to({startPosition:0},0).to({x:76,y:141.8},15).wait(21).to({startPosition:0},0).to({scaleX:0.43,scaleY:0.43,x:46.3,y:90.9},16).wait(9).to({startPosition:0},0).to({alpha:0},9).wait(1).to({startPosition:0},0).wait(1102));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(230).to({alpha:1},0).to({x:221.5,y:141.8},15).wait(21).to({startPosition:0},0).to({scaleX:0.42,scaleY:0.42,x:268.6,y:90.8},16).wait(9).to({startPosition:0},0).to({alpha:0},9).wait(1).to({startPosition:0},0).wait(1009));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(230).to({alpha:1},0).to({x:270,y:141.8},15).wait(21).to({startPosition:0},0).to({regX:16.9,scaleX:0.42,scaleY:0.42,x:288.8,y:90.8},16).wait(9).to({startPosition:0},0).to({alpha:0},9).wait(1).to({startPosition:0},0).wait(1009));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(323).to({alpha:1},0).to({x:221.5,y:141.6},15).wait(21).to({startPosition:0},0).to({regX:30.4,regY:13.7,scaleX:0.42,scaleY:0.42,x:195.4,y:90.7},16).wait(9).to({startPosition:0},0).to({alpha:0},9).wait(1).to({startPosition:0},0).wait(916));
	...
	this.instance_30.setTransform(102.7,90.3,0.435,0.435,0,-0.9,0,17,13.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_31).wait(323).to({alpha:1},0).to({x:270,y:141.6},15).wait(21).to({startPosition:0},0).to({regX:17.1,regY:13.7,scaleX:0.42,scaleY:0.42,x:215.6,y:90.7},16).wait(9).to({startPosition:0},0).to({alpha:0},9).wait(1).to({startPosition:0},0).wait(916));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_32).wait(420).to({alpha:1},0).to({x:362.5,y:140.8},15).wait(21).to({startPosition:0},0).to({regX:13.7,regY:13.7,scaleX:0.42,scaleY:0.42,x:405,y:90},16).wait(9).to({startPosition:0},0).to({alpha:0},9).wait(1).to({startPosition:0},0).wait(819));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_33).wait(420).to({alpha:1},0).to({x:410,y:140.8},15).wait(21).to({startPosition:0},0).to({regY:13.7,scaleX:0.42,scaleY:0.42,x:432.5,y:90},16).wait(9).to({startPosition:0},0).to({alpha:0},9).wait(1).to({startPosition:0},0).wait(819));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_34).wait(515).to({alpha:1},0).to({x:362.5,y:140.8},15).wait(21).to({startPosition:0},0).to({regY:13.7,scaleX:0.43,scaleY:0.43,x:339.1,y:89.9},16).wait(9).to({startPosition:0},0).to({alpha:0},9).wait(1).to({startPosition:0},0).wait(724));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_35).wait(515).to({alpha:1},0).to({x:410,y:140.8},15).wait(21).to({startPosition:0},0).to({regY:13.7,scaleX:0.43,scaleY:0.43,x:359.3,y:89.9},16).wait(9).to({startPosition:0},0).to({alpha:0},9).wait(1).to({startPosition:0},0).wait(724));
	...
	this.instance_39.setTransform(393.5,90.1,0.405,0.405,0,0,0,17.1,13.8);
	this.instance_39.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_39).wait(1179).to({startPosition:0},0).to({alpha:1},9).wait(9).to({startPosition:0},0).to({regX:17,scaleX:1,scaleY:1,x:410,y:140.8,alpha:0},16).wait(97));
	...
	this.instance_41.setTransform(267.9,90.6,0.407,0.407,0,0,0,30.4,13.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_42).wait(1071).to({scaleX:0.99,scaleY:0.93,x:285,y:294.8,alpha:1},0).wait(239));
	...
	this.instance_44.setTransform(280.6,85,0.407,0.407);
	...
	this.instance_51.setTransform(374.2,90.1,0.405,0.405,0,0,0,30.6,13.8);
	...
	this.instance_59.setTransform(120.6,90.8);
